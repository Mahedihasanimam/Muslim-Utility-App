...
export interface SpecialPrayer {
    key: string;
    name_bn: string;
    time_bn: string; // পড়ার সময়
    rakats_bn: string; // রাকাত সংখ্যা
    method_bn: string[]; // পড়ার নিয়ম (ধাপে ধাপে)
...
export const prayersInfo: PrayerInfo[] = [
    { key: 'fajr', name_bn: 'ফজর', rakats: { sunnah_muakkadah: 2, fardh: 2 }, notes_bn: 'ফরজের আগে ২ রাকাত সুন্নাত পড়তে হয়।' },
    { key: 'dhuhr', name_bn: 'যোহর', rakats: { sunnah_muakkadah: 4, fardh: 4, sunnah_ghair_muakkadah: 2, nafl: 2 }, notes_bn: 'ফরজের আগে ৪ ও পরে ২ রাকাত সুন্নাত (মুয়াক্কাদা)। শেষে ২ রাকাত নফল পড়তে পারেন।' },
    { key: 'asr', name_bn: 'আসর', rakats: { sunnah_ghair_muakkadah: 4, fardh: 4 }, notes_bn: 'ফরজের আগে ৪ রাকাত সুন্নাত (গায়রে মুয়াক্কাদা)।' },
    { key: 'maghrib', name_bn: 'মাগরিব', rakats: { fardh: 3, sunnah_muakkadah: 2, nafl: 2 }, notes_bn: 'ফরজের পরে ২ রাকাত সুন্নাত (মুয়াক্কাদা)। শেষে ২ রাকাত نفل পড়তে পারেন।' },
    { key: 'isha', name_bn: 'ইশা', rakats: { sunnah_ghair_muakkadah: 4, fardh: 4, sunnah_muakkadah: 2, nafl: 2, witr: 3 }, notes_bn: 'ফরজের আগে ৪ রাকাত সুন্নাত (গায়রে মুয়াক্কাদা), পরে ২ রাকাত সুন্নাত (মুয়াক্কাদা)। শেষে ৩ রাকাত বিতর ওয়াজিব।' },
];

// --- এক রাকাতের সাধারণ ধাপসমূহ (!!!বাংলা উচ্চারণ ও দোয়া যাচাই করুন!!!) ---
export const salahSteps: SalahStep[] = [
    ...
    {
        step: 2, posture: 'কিয়াম', action_bn: 'সানা পড়া',
        recite_ar: ['سُبْحَانَكَ اللَّهُمَّ وَبِحَمْدِكَ', 'وَتَبَارَكَ اسْمُكَ وَتَعَالَى جَدُّكَ', 'وَلَا إِلَهَ غَيْرُكَ'],
        recite_pronun_bn: ['সুবহা-নাকাল্লা-হুম্মা ওয়া বিহামদিকা', 'ওয়া তাবা-রা কাসমুকা ওয়া তা‘আ-লা জাদ্দুকা', 'ওয়া লা-ইলা-হা গাইরুক'],
        recite_bn: ['হে আল্লাহ! আপনার পবিত্রতা বর্ণনা করছি। আপনার প্রশংসার সাথে আপনার নাম বরকতময়, আপনার মহত্ত্ব সুউচ্চ এবং আপনি ব্যতীত অন্য কোনো উপাস্য নেই।'],
        icon: 'human-male'
    },
    {
        step: 3, posture: 'কিয়াম', action_bn: 'সুরা ফাতিহা পড়া',
        ...
        recite_bn: ['পরম করুণাময় অসীম দয়ালু আল্লাহর নামে শুরু করছি।', 'সমস্ত প্রশংসা আল্লাহর জন্য যিনি জগৎসমূহের প্রতিপালক...'],
        icon: 'human-male'
    },
    {
        step: 4, posture: 'কিয়াম', action_bn: 'অন্য একটি সুরা বা কমপক্ষে তিন আয়াত মেলানো',
        recite_ar: ['(উদাহরণ: সুরা ইখলাস)', 'قُلْ هُوَ اللَّهُ أَحَدٌ...'],
        recite_pronun_bn: ['(উদাহরণ)', 'ক্বুল হুওয়াল্ল-হু আহাদ...'],
        recite_bn: ['(আপনার পছন্দমত একটি সুরা)'],
        icon: 'human-male'
    },
    {
        step: 5, posture: 'রুকু', action_bn: 'আল্লাহু আকবার বলে রুকুতে যাওয়া',
        recite_ar: ['سُبْحَانَ رَبِّيَ الْعَظِيمِ'],
        recite_pronun_bn: ['সুবহা-না রাব্বিয়াল ‘আযী-ম (৩ বার)'],
        recite_bn: ['আমার মহান প্রতিপালকের পবিত্রতা বর্ণনা করছি (৩ বার)।'],
        icon: 'human-handsdown'
    },
    {
        step: 6, posture: 'কওমা', action_bn: 'সামিআল্লাহু লিমান হামিদাহ বলে সোজা দাঁড়ানো',
    ...
    {
        step: 7, posture: 'সিজদাহ ১', action_bn: 'আল্লাহু আকবার বলে প্রথম সিজদায় যাওয়া',
        recite_ar: ['سُبْحَانَ رَبِّيَ الْأَعْلَى'],
        recite_pronun_bn: ['সুবহা-না রাব্বিয়াল আ‘লা (৩ বার)'],
    ...
    },
    {
        ...
        recite_pronun_bn: ['(ঐচ্ছিক: আল্লা-হুম্মাগফিরলী ওয়ারহামনী...)'],
        recite_bn: ['(ঐচ্ছিক: হে আল্লাহ, আমাকে ক্ষমা করুন, আমার প্রতি দয়া করুন...)'],
        icon: 'human-male-female'
    },
    {
        step: 9, posture: 'সিজদাহ ২', action_bn: 'আল্লাহু আকবার বলে দ্বিতীয় সিজদায় যাওয়া',
        recite_ar: ['سُبْحَانَ رَبِّيَ الْأَعْلَى'],
        recite_pronun_bn: ['সুবহা-না রাব্বিয়াল আ‘লা (৩ বার)'],
        recite_bn: ['আমার সর্বোচ্চ প্রতিপালকের পবিত্রতা বর্ণনা করছি (৩ বার)।'],
        icon: 'human-handsdown'
    ...
    {
        step: 10, posture: 'দাঁড়ানো/বসা', action_bn: 'আল্লাহু আকবার বলে দাঁড়ানো (পরের রাকাতের জন্য) অথবা বসা (তাশাহহুদের জন্য)',
...
export const specialPrayers: SpecialPrayer[] = [
    {
        ...
        time_bn: 'ইশার নামাজের পর থেকে সুবহে সাদিকের পূর্ব পর্যন্ত, রাতের শেষ তৃতীয়াংশ উত্তম সময়।',
        rakats_bn: 'কমপক্ষে ২ রাকাত, সাধারণত ৮ রাকাত পড়া হয়, তবে ১২ রাকাত পর্যন্ত পড়ার वर्णन পাওয়া যায়। ২ রাকাত করে পড়া উত্তম।',
        method_bn: [
            '১. অন্যান্য নফল নামাজের মতোই নিয়ত করে শুরু করুন।',
            '২. প্রত্যেক রাকাতে সুরা ফাতিহার সাথে অন্য যে কোনো সুরা (লম্বা সুরা পড়া উত্তম) মিলিয়ে পড়ুন।',
            '৩. প্রতি দুই রাকাত পর সালাম ফেরান।',
            '৪. আপনি যত রাকাত পড়তে চান (২, ৪, ৬, ৮...), তা পড়ার পর সম্ভব হলে বিতর নামাজ পড়ুন (যদি ইশার সাথে না পড়ে থাকেন)।',
        ],
        importance_bn: 'ফরজ নামাজের পর সবচেয়ে শ্রেষ্ঠ নামাজ হলো তাহাজ্জুদ। এটি আল্লাহর নৈকট্য লাভের অন্যতম সেরা উপায়।'
    },
];
...
const styles = StyleSheet.create({
    ...
    stepReciteArabic: { color: TEXT_PRIMARY, fontSize: 18, textAlign: 'right', marginBottom: 5, fontFamily: Platform.OS === 'ios' ? 'Arial' : 'sans-serif' },
    stepRecitePronunBn: { color: '#A5F3FC', fontSize: 14, marginBottom: 5, fontStyle: 'italic' },
    stepReciteTranslit: { color: '#94A3B8', fontSize: 12, marginBottom: 5, fontStyle: 'italic' },
...
const SpecialPrayerItem: React.FC<{ prayer: SpecialPrayer }> = ({ prayer }) => (
    <View style={styles.specialPrayerCard}>
        ...
        <Text style={styles.specialPrayerLabel}>সময়:</Text>
        ...
        <Text style={styles.specialPrayerLabel}>পড়ার নিয়ম:</Text>
...
const NamazGuideScreen = () => {
    ...
    const getRakatString = (rakats: PrayerInfo['rakats']) => {
        ...
        if (rakats.sunnah_muakkadah && ['fajr', 'dhuhr'].includes(selectedPrayer.key)) parts.push(`${rakats.sunnah_muakkadah} সুন্নাত (মু.)`);
        if (rakats.fardh) parts.push(`${rakats.fardh} ফরজ`);
        if (rakats.sunnah_muakkadah && ['dhuhr', 'maghrib', 'isha'].includes(selectedPrayer.key)) parts.push(`${rakats.sunnah_muakkadah} সুন্নাত (মু.)`);
        if (rakats.nafl) parts.push(`${rakats.nafl} নফল`);
        if (rakats.witr) parts.push(`${rakats.witr} বিতর (ওয়াজিব)`);
        return parts.join(' + ');
    };
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                <Text style={styles.headerTitle}>নামাজের নিয়ম</Text>
            ...
            <ScrollView>
                ...
                <Text style={styles.sectionTitle}>কিভাবে পড়বেন (প্রথম রাকাত):</Text>
                {salahSteps.map(step => (
                    <StepItem key={`r1-${step.step}`} step={step} />
                ))}

                <Text style={styles.sectionTitle}>দ্বিতীয় রাকাত ও বৈঠক:</Text>
                <View style={[styles.stepCard, { backgroundColor: CARD_COLOR_PRIMARY, flexDirection: 'column' }]}>
                    <Text style={[styles.stepAction, { marginBottom: 8 }]}>দ্বিতীয় রাকাত:</Text>
                    <Text style={styles.stepReciteBn}>
                        - দ্বিতীয় রাকাত প্রথম রাকাতের মতোই শুরু করুন, তবে শুরুতে সানা পড়তে হবে না। {"\n"}
                        - সুরা ফাতিহার পর অন্য একটি সুরা বা কিছু আয়াত মেলান।{"\n"}
                        - রুকু ও সিজদাহ্ স্বাভাবিক নিয়মে করুন।{"\n"}
                        - দ্বিতীয় সিজদার পর বসুন।
                    </Text>
                    <Text style={[styles.stepAction, { marginTop: 15, marginBottom: 8 }]}>বৈঠক (ক্বadah):</Text>
                    <Text style={styles.stepReciteBn}>
                        - <Text style={{ fontWeight: 'bold' }}>২ রাকাত বিশিষ্ট নামাজে (ফজর, সুন্নাত, নফল):</Text> দ্বিতীয় রাকাতের শেষ সিজদার পর বসে তাশাহহুদ (আত্তাহিয়্যাতু), দরুদ শরিফ ও দোয়া মাসুরা পড়ে ডানে ও বামে সালাম ফেরাতে হবে।{"\n"}
                        - <Text style={{ fontWeight: 'bold' }}>৩ বা ৪ রাকাত বিশিষ্ট নামাজে (যোহর, আসর, মাগরিব, ইশা):</Text> দ্বিতীয় রাকাতের সিজদার পর বসে শুধু তাশাহহুদ (আত্তাহিয়্যাতু) পড়ে আল্লাহু আকবার বলে তৃতীয় রাকাতের জন্য দাঁড়াতে হবে।
                    </Text>
                </View>
                ...
                {(selectedPrayer.rakats.fardh > 2 || selectedPrayer.rakats.sunnah_muakkadah === 4 || selectedPrayer.rakats.sunnah_ghair_muakkadah === 4 || selectedPrayer.rakats.witr === 3) && (
                    <>
                        <Text style={styles.sectionTitle}>তৃতীয় ও চতুর্থ রাকাত:</Text>
                        <View style={[styles.stepCard, { backgroundColor: CARD_COLOR_PRIMARY, flexDirection: 'column' }]}>
                            <Text style={[styles.stepAction, { marginBottom: 8 }]}>তৃতীয় রাকাত:</Text>
                            <Text style={styles.stepReciteBn}>
                                - সুরা ফাতিহা পড়ুন।{"\n"}
                                - <Text style={{ fontWeight: 'bold' }}>ফরজ নামাজে:</Text> সুরা ফাতিহার পর অন্য সুরা মেলানো হয় না।{"\n"}
                                - <Text style={{ fontWeight: 'bold' }}>সুন্নাত/নফল/বিতর নামাজে:</Text> সুরা ফাতিহার পর অন্য সুরা বা আয়াত মেলান।{"\n"}
                                - রুকু ও সিজদাহ্ স্বাভাবিক নিয়মে করুন।{"\n"}
                                - <Text style={{ fontWeight: 'bold' }}>৩ রাকাত বিশিষ্ট নামাজে (মাগরিব ফরজ, বিতর):</Text> তৃতীয় রাকাতের শেষ সিজদার পর বসে পড়ুন (শেষ বৈঠক)।{"\n"}
                                - <Text style={{ fontWeight: 'bold' }}>৪ রাকাত বিশিষ্ট নামাজে:</Text> তৃতীয় রাকাতের শেষ সিজদার পর আল্লাহু আকবার বলে চতুর্থ রাকাতের জন্য দাঁড়ান।
                            </Text>
                            <Text style={[styles.stepAction, { marginTop: 15, marginBottom: 8 }]}>চতুর্থ রাকাত (যদি থাকে):</Text>
                            <Text style={styles.stepReciteBn}>
                                - তৃতীয় রাকাতের মতোই পড়ুন (ফরজ হলে ফাতিহার পর সুরা মেলানো ছাড়া)।{"\n"}
                ...
                <View style={[styles.stepCard, { backgroundColor: CARD_COLOR_PRIMARY, flexDirection: 'column' }]}>
                    <Text style={styles.stepReciteBn}>
                        - শেষ বৈঠকে তাশাহহুদ (আত্তাহিয়্যাতু), দরুদ শরিফ (আল্লাহুম্মা সাল্লি আলা... বারিক আলা...) এবং দোয়া মাসুরা (আল্লাহুম্মা ইন্নি যালামতু নাফসি...) পড়ুন।{"\n"}
                        - প্রথমে ডান দিকে, তারপর বাম দিকে মুখ ফিরিয়ে বলুন "আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ"।
                    </Text>
                    {/* !!! এখানে তাশাহহুদ, দরুদ, দোয়া মাসুরা, সালামের টেক্সট, উচ্চারণ ও অর্থ যোগ করতে হবে !!! */}
                    <View style={{ marginTop: 15 }}>
                        <Text style={[styles.stepAction, { color: ACCENT_COLOR }]}> (এখানে আত্তাহিয়্যাতু, দরুদ ইত্যাদি দেখান)</Text>
                    </View>
                </View>

                {selectedPrayer.key === 'isha' && (
                    <>
                        <Text style={styles.sectionTitle}>বিতর নামাজের নিয়ম (দোয়া কুনুত):</Text>
                        <View style={[styles.stepCard, { backgroundColor: CARD_COLOR_PRIMARY, flexDirection: 'column' }]}>
                            <Text style={styles.stepReciteBn}>
                                - ইশার ৩ রাকাত বিতর নামাজের তৃতীয় রাকাতে সুরা ফাতিহা ও অন্য সুরা মেলানোর পর, রুকুতে যাওয়ার আগে "আল্লাহু আকবার" বলে হাত কান পর্যন্ত উঠিয়ে আবার নাভির নিচে বাঁধতে হবে।{"\n"}
                                - এরপর দোয়া কুনুত পড়ুন।{"\n"}
                                - তারপর আল্লাহু আকবার বলে রুকুতে যান এবং বাকি নামাজ স্বাভাবিক নিয়মে শেষ করুন।
                            </Text>
                            {/* !!! এখানে দোয়া কুনুতের টেক্সট, উচ্চারণ ও অর্থ যোগ করতে হবে !!! */}
                            <View style={{ marginTop: 15 }}>
                                <Text style={[styles.stepAction, { color: ACCENT_COLOR }]}> (এখানে দোয়া কুনুত দেখান)</Text>
                            </View>
                        </View>
                    </>
                )}
